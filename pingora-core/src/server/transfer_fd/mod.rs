...
mod tests {
    ...
    fn test_send_receive_fds() {
        ...
        let raw_fd = dumb_fd.into_raw_fd();
        let fds = vec![raw_fd];
    ...
    fn test_serde_via_socket() {
        ...
        .unwrap();
        let raw_fd1 = dumb_fd1.into_raw_fd();
        fds.add(key1.clone(), raw_fd1);
        let key2 = "1.1.1.1:443".to_string();
        ...
        .unwrap();
        let raw_fd2 = dumb_fd2.into_raw_fd();
        fds.add(key2.clone(), raw_fd2);
