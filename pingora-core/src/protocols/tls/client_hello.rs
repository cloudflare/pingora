...
const TLS_HANDSHAKE_TYPE_CLIENT_HELLO_TLS13: u8 = 0x01; // Same type in TLS 1.3

// TLS extensions (RFC 8446, RFC 6066, etc.)
const EXT_SERVER_NAME: u16 = 0x0000;
const EXT_MAX_FRAGMENT_LENGTH: u16 = 0x0001;
...
const EXT_COMPRESS_CERTIFICATE: u16 = 0x001b; // TLS 1.3
const EXT_RECORD_SIZE_LIMIT: u16 = 0x001c; // TLS 1.3
